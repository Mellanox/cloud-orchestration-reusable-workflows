...
FROM nvcr.io/nvstaging/doca/doca:full-rt-3.5.0036-host-dev AS BASE_IMAGE_DOCA_FULL_RT_HOST
FROM nvcr.io/nvstaging/doca/doca:base-rt-3.5.0036-host-dev AS BASE_IMAGE_DOCA_BASE_RT_HOST
