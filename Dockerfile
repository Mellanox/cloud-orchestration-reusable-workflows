...
FROM nvcr.io/nvstaging/doca/doca:3.3.0108-full-rt-host AS BASE_IMAGE_DOCA_FULL_RT_HOST
FROM nvcr.io/nvstaging/doca/doca:3.3.0108-base-rt-host AS BASE_IMAGE_DOCA_BASE_RT_HOST
